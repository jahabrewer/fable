 ...
 */
	Configure::write('Routing.prefixes', array('admin', 'teacher', 'substitute'));
 ...
 */
	Configure::write('Security.salt', 'lkj42093l4kjslufdsjfdDFJSK23jlk');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '9823749832796623847832');

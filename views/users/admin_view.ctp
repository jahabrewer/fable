...
<div class="users view">
	<div class="buttons">
		<?php echo $this->Html->link('Edit', array('action' => 'edit', $user['User']['id']), array('id' => 'edit')); ?>
		<?php echo $this->Html->link('Delete', array('action' => 'delete', $user['User']['id']), array('id' => 'delete'), 'Are you sure you want to delete this user?'); ?>
	</div>
